...
@Composable
fun ChatAiScreen(homeViewModel: HomeViewModel = viewModel()) {
    ...
    HomeScreen(uiState = appuistate.value) { inputText, selectedItems ->
        ...
        corotineScope.launch {
            ...
            homeViewModel.questioning(userInput = inputText, selectImages = bitmaps)
        }
...
fun HomeScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Study Squads GPT") },
            ...
            Column {
                Row(
                    ...
                    OutlinedTextField(
                        ...
                        placeholder = { Text(text = "Ask AnyThing And Upload Image") },
            ...
            when (uiState) {
                ...
                is HomeUiState.Error -> {
                    Card(
                        ...
                        Text(text = "Enter The Image Or Check Internet Connection")
                    }
                }
            }
        }
